...
var reviews = [
  ...
  },
  {
    ...
    "date": "2025-03-05",
    "rating": 5,
    "text": "Пришел целый. Брали в подарок сыну на ДР. Крутейшая конечно техника. Как я поняла, нужно покупать хороший пластик и соблюдать влажность и чистоту при работе. Будем покупать AMS систему для многоцветной печати. Рекомендую продавца.",
